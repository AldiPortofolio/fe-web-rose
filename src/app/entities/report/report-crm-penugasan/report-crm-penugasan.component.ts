...
import { ReportCrmPenugasan } from './report-crm-penugassan.model';
...
@Component({
  selector: 'op-report-crm-penugasan',
  templateUrl: './report-crm-penugasan.component.html',
  styleUrls: ['./report-crm-penugasan.component.css']
})
export class ReportCrmPenugasanComponent implements OnInit {

    reportList: ReportCrmPenugasan[];
    curPage = 1;
    totalData = 0;
    ...
    constructor(private ngxService: NgxUiLoaderService,
        private reportCrmPenugasanService: ReportCrmPenugasanService) { }
    ...
    loadAll(page) {
        ...
        this.reportCrmPenugasanService.filter({
            ...
            .subscribe(
                (res: HttpResponse<ReportCrmPenugasan[]>) => this.onSuccessGetData(res.body),
    ...
    sendKafka() {
        ...
        this.reportCrmPenugasanService.sendKafka({
            ...
            .subscribe(
                (res: HttpResponse<ReportCrmPenugasan[]>) => this.onSuccess(res.body),
                (res: HttpErrorResponse) => this.onError(res.message),
                () => { console.log('finally'); }
            );
    }
