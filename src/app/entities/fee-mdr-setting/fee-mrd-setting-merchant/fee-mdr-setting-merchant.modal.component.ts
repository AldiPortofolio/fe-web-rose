...
@Component({
  selector: 'op-fee-mdr-setting-merchant-modal',
  templateUrl: './fee-mdr-setting-merchant.modal.component.html',
  styleUrls: ['./fee-mdr-setting-merchant.modal.component.css']
})
export class FeeMdrSettingMerchantModalComponent implements OnInit {

  @Input() statusRec;
  @Input() objEdit: FeeMdrSettingMerchant;
  @Input() viewMsg;
  ...
  constructor(private modalService: NgbModal,
    ...
    private feeMdrService: FeeMrdSettingMerchantService,
  ...
  ngOnInit() {
    ...
    if (this.statusRec === 'addnew') {
      ...
      this.feeMdr.merchantFeeType = 'Amount';
      this.feeMdr.merchantFee = 0;
      this.feeMdr.customerFeeType = 'Amount';
      this.feeMdr.customerFee = 0;
      this.feeMdr.status = 'y';
    } else {
