...
export class UploadFeeMdrSettingService {

    private serverUrl = SERVER_GO + 'upload-fee-mdr-setting';

    constructor(private http: HttpClient) { }

    filter(req?: any): Observable<HttpResponse<UploadFeeMdrSetting[]>> {
        let dataUploadMerchantUrl = null;

        dataUploadMerchantUrl = this.serverUrl + '/all';

        return this.http.post<UploadFeeMdrSetting[]>(dataUploadMerchantUrl, req, { observe: 'response' })
            .pipe(
