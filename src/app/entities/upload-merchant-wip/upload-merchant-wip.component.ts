...
@Component({
  ...
  templateUrl: './upload-merchant-wip.component.html',
  styleUrls: ['./upload-merchant-wip.component.css']
})
export class UploadMerchantWipComponent implements OnInit {
    ...
    constructor(
        ...
        private uploadMerchantService: UploadMerchantWipService,
