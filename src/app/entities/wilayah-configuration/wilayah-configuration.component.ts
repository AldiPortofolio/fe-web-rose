...
export class WilayahConfigurationComponent implements OnInit {
    ...
    private onSuccess(data, headers) {
        ...
        console.log('ISI DATA CONTENT:', this.wilayahConfigList);
    ...
    add() {
        ...
        const prov = _.find(this.provinsiList, { 'id': parseInt(this.provinsiSelected) });
        const dati = _.find(this.dati2List, { 'id': parseInt(this.dati2Selected) });
        const kec = _.find(this.kecamatanList, { 'id': parseInt(this.kecamatanSelected) });
        const kel = _.find(this.kelurahanList, { 'id': parseInt(this.kelurahanSelected) });

        console.log('feby : ', prov.name);
        ...
        if (this.kelurahanSelected !== '0') {
            ...
            newWilayahConfig.kelurahan = kel.name;
            newWilayahConfig.kecamatan = kec.name;
            newWilayahConfig.dati2 = dati.name;
            newWilayahConfig.provinsi = prov.name;
        } else if (this.kecamatanSelected !== '0') {
            newWilayahConfig.level = WILAYAH_KECAMATAN;
            newWilayahConfig.levelId = this.kecamatanSelected;
            newWilayahConfig.kelurahan = 'All';
            newWilayahConfig.kecamatan = kec.name;
            newWilayahConfig.dati2 = dati.name;
            newWilayahConfig.provinsi = prov.name;
            ...
            newWilayahConfig.kelurahan = 'All';
            newWilayahConfig.kecamatan = 'All';
            newWilayahConfig.dati2 = dati.name;
            newWilayahConfig.provinsi = prov.name;
