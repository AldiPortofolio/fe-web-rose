...
export class UploadMerchantNonActivatedService {

  private serverUrl = SERVER_GO + 'upload-merchant-ok';

  constructor(private http: HttpClient) { }

  filter(req?: any): Observable<HttpResponse<UploadMerchantNonActivated[]>> {
    let dataUploadMerchantUrl = null;

    dataUploadMerchantUrl = this.serverUrl + '/all';

    return this.http.post<UploadMerchantNonActivated[]>(dataUploadMerchantUrl, req, { observe: 'response' })
      .pipe(
