...
@Component({
  selector: 'op-upload-merchant',
  templateUrl: './upload-merchant.component.html',
  styleUrls: ['./upload-merchant.component.css']
})
export class UploadMerchantComponent implements OnInit {
    ...
    constructor(
        ...
        private uploadMerchantService: UploadMerchantService,
