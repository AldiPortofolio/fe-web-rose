...
export class UploadMerchantBankLoanService {

    private serverUrl = SERVER_GO+ 'upload-merchant-bank-loan';


    constructor(private http: HttpClient) { }

    filter(req?: any): Observable<HttpResponse<UploadMerchantBankLoan[]>> {
        ...
        return this.http.post<UploadMerchantBankLoan[]>(dataUploadMerchantUrl, req['filter'], { observe: 'response' })
            .pipe(
