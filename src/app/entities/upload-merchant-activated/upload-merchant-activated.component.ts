...
@Component({
  selector: 'op-upload-merchant-activated',
  templateUrl: './upload-merchant-activated.component.html',
  styleUrls: ['./upload-merchant-activated.component.css']
})
export class UploadMerchantActivatedComponent implements OnInit {

  uploadList: UploadMerchantActivated[];
  uploadNmidRes: UploadMerchantActivated;
  ...
  constructor(
    ...
    private uploadService: UploadMerchantActivatedService,
  ...
  loadAll(page) {
    ...
    this.uploadService.filter({
      ...
      .subscribe(
        (res: HttpResponse<UploadMerchantActivated[]>) => this.onSuccessGetData(res.body),
  ...
  submitUpload() {
    ...
    this.uploadService.uploadFile(formData)
      .subscribe(
        (res: HttpResponse<UploadMerchantActivated>) => this.onSuccess(res),
        (res: HttpErrorResponse) => this.onError(res.message),
        // result => {
